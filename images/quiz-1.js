...
$("#category98").show("slow");    
}        

else {   
$("#results").hide("slow");             
$("#category98").hide("slow");             
var cat1name = "1";            
var cat2name = "2";            
var cat3name = "3";            
var cat4name = "4";            
...
var cat18 = ($("input[@name=q18]:checked").val() != "c"); 

var cat19 = ($("input[@name=q19]:checked").val() != "c"); 

var cat20 = ($("input[@name=q20]:checked").val() != "d"); 

var cat99 = (!cat1 && !cat2 && !cat3 && !cat4 && !cat5 && !cat6 && !cat7 && !cat8 && !cat9 && !cat10 && !cat11 && !cat12 && !cat13 && !cat14 && !cat15 && !cat16 && !cat17 && !cat18 && !cat19 && !cat20); var categories = [];                        
...
if (cat99) { categories.push(cat99name) };                        
